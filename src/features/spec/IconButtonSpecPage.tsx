  ...
  return (
    <>
      <header className="mb-2xl">
        ...
        <h1 className="text-h1 text-ink-primary mb-sm">IconButton</h1>
        ...
        <div className="bg-surface-card border border-surface-divider rounded-card p-xl">
          <div className="flex flex-col gap-lg">
            <div>
              ...
              <p className="text-small text-ink-tertiary mt-xs">Resting, active, disabled</p>
            </div>
            <div>
              <p className="text-label text-ink-tertiary uppercase mb-sm">ghost</p>
              <div className="flex gap-md items-center">
                <IconButton icon="×" onClick={() => {}} variant="ghost" ariaLabel="Close" />
        ...
        <div className="bg-surface-card border border-surface-divider rounded-card p-xl">
          <div className="flex flex-col gap-lg">
            <div className="flex items-center gap-md">
              <div className="w-[60px] text-small text-ink-tertiary">md</div>
              <IconButton icon="♡" onClick={() => {}} ariaLabel="Save" />
              <IconButton icon="×" onClick={() => {}} variant="ghost" ariaLabel="Close" />
            </div>
            <div className="flex items-center gap-md">
              <div className="w-[60px] text-small text-ink-tertiary">sm</div>
