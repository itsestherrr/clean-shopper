  ...
  return (
    <>
      <header className="mb-2xl">
        ...
        <h1 className="text-h1 text-text-primary mb-sm">IngredientBar</h1>
...
{`<IngredientBar counts={{ clean: 12, caution: 3, avoid: 1 }} />`}
      ...
      <section id="variations" className="mb-3xl">
        <h2 className="text-h2 text-text-primary mb-md">Data variations</h2>
        ...
        <div className="bg-surface-card border border-surface-divider rounded-card p-xl">
          <div className="flex flex-col gap-xl">
            {EXAMPLES.map((ex) => (
              <div key={ex.label}>
                <p className="text-label text-text-tertiary uppercase mb-sm">{ex.label}</p>
