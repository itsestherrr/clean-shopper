  ...
  return (
    <>
      <button
        ...
        className="bg-primary text-surface-card rounded-full text-body px-lg py-sm cursor-pointer border-none hover:bg-primary-dark transition-colors duration-fast ease-default"
      >
        Open {label}
      </button>
  ...
  return (
    <>
      <header className="mb-2xl">
        ...
        <h1 className="text-h1 text-text-primary mb-sm">Modal</h1>
  ...
  <p>Are you sure you want to remove this product?</p>
      ...
      <section id="accessibility" className="mb-3xl">
        ...
        <div className="space-y-lg max-w-[720px]">
          ...
          <div>
            <h3 className="text-h4 text-text-primary mb-sm">Scroll</h3>
            <dl className="space-y-xs">
              {[
